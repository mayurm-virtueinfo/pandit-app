...
const AddPujaScreen: React.FC = () => {
  ...
  const [selectedPriceOption, setSelectedPriceOption] = useState<
    'system' | 'custom'
  >('system');
  const [customPriceWithItems, setCustomPriceWithItems] = useState('7000');
  const [customPriceWithoutItems, setCustomPriceWithoutItems] =
    useState('5500');
  ...
  const handleAddPuja = () => {
    // TODO: Implement add puja logic
    console.log('Add Puja pressed');
    console.log('Selected Puja:', selectedPuja);
    console.log('Selected Price Option:', selectedPriceOption);
    console.log('Custom Prices:', {
  ...
  const renderPujaOption = (puja: PujaListItemType, index: number) => (
    <View key={puja.id}>
      <TouchableOpacity
  ...
  return (
    <SafeAreaView style={styles.container}>
      <UserCustomHeader title={t('add_puja')} showBackButton={true} />
