    ...
    <>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          {/* Pandit Info */}
          <TouchableOpacity
            onPress={handlePanditLocationPress}
            style={styles.row}>
            <Image
        ...
        <TouchableOpacity onPress={handlePinVerify} style={styles.primaryBtn}>
          <Text style={styles.primaryBtnText}>{t('pin_verify')}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.primaryBtn}
          onPress={handleRateYourExperience}>
          <Text style={styles.primaryBtnText}>{t('rate_your_experience')}</Text>
        </TouchableOpacity>
        <TouchableOpacity
